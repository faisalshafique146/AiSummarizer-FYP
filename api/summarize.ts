...
// Keep the provider deadline below Vercel's function deadline so the route has
// time to return a typed JSON error instead of being terminated by the platform.
const upstreamTimeoutMilliseconds = 25_000;
